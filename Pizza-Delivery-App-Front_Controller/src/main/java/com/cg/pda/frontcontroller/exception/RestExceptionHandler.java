...
public class RestExceptionHandler extends ResponseEntityExceptionHandler{
	...
	@ExceptionHandler({InvalidOrderException.class, PizzaNotAvailableException.class,
		InvalidLoginCredentialsException.class, NoPizzaAvailableException.class,
		PizzaAlreadyRemovedException.class, TypeOfPizzaNotAvailableException.class})
